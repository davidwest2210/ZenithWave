...
#[derive(Debug)]
pub struct ZenithWaveProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ZenithWaveProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ZenithWave processing");
    
    let mut processor = ZenithWaveProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ZenithWaveProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ZenithWaveProcessor::new(false);
